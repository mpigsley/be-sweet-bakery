          ...
          <div className="row">
            ...
            <div className="ten columns">
              <p>
                ...
                design - if you can dream it, we can make it! As always, Be Sweet
                Bakery ships nationwide, so we can send cookies anywhere you
        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="four columns">
              <img className="About-Image" src={brianna} alt="Brianna Pigsley" />
            </div>
            <div className="six columns">
              <p>
                Baking sweet treats has been a lifelong passion. As a young girl,
                my parents purchased an easy bake oven for me and almost
                immediately, my passion was born! From cakes to cookies, cupcakes
                to pies, I wanted to make it all! I always took great joy in
                baking for friends and family and was encouraged to open my own
                business. While achieving my business degree from University of
                Nebraska - Omaha, I finally decided to make my dreams a reality
                in October 2015! I am now the full time owner/designer for
                Be Sweet Bakery.
              </p>
            </div>
            <div className="one column">&nbsp;</div>
